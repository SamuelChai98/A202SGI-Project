...
import com.inti.student.cricfeed.Adapter.NewsAdapter;
...
public class NewsFragment extends Fragment {
    ...
    //source url
    private final String RSS_url="http://www.espncricinfo.com/rss/content/story/feeds/0.xml";
    ...
    private void loadRSS(){
        ...
        AsyncTask<String,String,String> loadRSSAsync = new AsyncTask<String, String, String>() {
            ...
            protected void onPostExecute(String s) {
                ...
                NewsAdapter adapter = new NewsAdapter(rssObject,getActivity().getBaseContext());
